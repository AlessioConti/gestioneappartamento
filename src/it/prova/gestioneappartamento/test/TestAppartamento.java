...
public class TestAppartamento {
	...
	public static void testInserimentoAppartamento(AppartamentoDAO appartamentoDAOInstance) {
		...
		int appartamentiInseriti = appartamentoDAOInstance
				.insert(new Appartamento(6L, "Magliana", 100, 189000, new Date("2022/05/16")));
	...
	public static void testFindById(AppartamentoDAO appartamentoDAOInstance) {
		...
		if (appartamentoDaCercareConDAO == null
				|| !appartamentoDaCercareConDAO.getQuartiere().equals(appartamentoProva.getQuartiere()))
